    ...
    return(
        <div className="Post">
            <div className="Post__Title">
                <div className="Post__Title__Title">광주 패들릿</div>
            ...
            <div>
                ...
                <div className="Post__PostEmpty">
                    <div className="Post__FontEmpty__Title">안녕하세요, {userinfo.userLocation}_{userinfo.userName}_{userinfo.userNickname}님</div>
                    <div className="Post__FontEmpty__Content">아직 광주 패들릿이 비어있어요!!!</div>
                    <div className="Post__FontEmpty__Content">가장 먼저 광주 패들릿에 글을 남겨 보아요 ˃́▿˂̀ </div>
